    ...
    <div className="relative">
      ...
      {open && (
        <ul
          ...
          ref={listRef}
          role="listbox"
          className="absolute z-30 mt-1 w-full max-h-48 overflow-auto rounded-md border bg-white shadow-lg"
        >
          {loading ? (
            ...
            <li
              ...
              className={`px-3 py-2 cursor-pointer ${highlight === i ? 'bg-primary/10' : ''}`}
